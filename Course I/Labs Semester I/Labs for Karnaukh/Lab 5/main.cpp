...
int main()
{
    ...
    const double a0=-0.9, b0=0.9, minh=0.1;
    double a, b, h, e, x;
    cout<<endl<<"Введіть a = ";
    cin>>a; if (cin.fail()) {cout<<endl<<" Некоректній ввід!"<<endl; return 0;}
    cout<<"Введіть b = ";
    cin>>b; if (cin.fail()) {cout<<endl<<" Некоректній ввід!"<<endl; return 0;}
    cout<<"Введіть h = ";
    cin>>h; if (cin.fail()) {cout<<endl<<" Некоректній ввід!"<<endl; return 0;}
    cout<<"Введіть e = ";
    cin>>e; if (cin.fail()) {cout<<endl<<" Некоректній ввід!"<<endl; return 0;}
    x=a;
    if ((a<a0) || (b>b0) || (a>=b) || (h<minh)) {cout<<endl<<" Некоректній ввід! Невідповідність вимогам!"<<endl; return 0;}
    allvyvid(x, b, h, e);
    return 0;
}
