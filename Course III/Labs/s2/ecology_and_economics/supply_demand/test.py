...
plt.scatter(df['price'], df['demand'], s=100, marker='x', c='r', label='$Q_d(P)$, true')
plt.scatter(df['price'], df['supply'], s=100, marker='x', c='b', label='$Q_s(P)$, true')
plt.plot(df_interp['price'], df_interp['supply'], 'b-', label='$Q_s(P)$', zorder=1)
plt.plot(df_interp['price'], df_interp['demand'], 'r-', label='$Q_d(P)$', zorder=1)
